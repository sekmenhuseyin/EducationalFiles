// Customer : Intel (Business Computing)
...
var ckAlreadyShown2 = triggerParms["ascookie2"]; // name of the persistent/session cookie

var ckAlreadyShown3 = triggerParms["ascookie3"]; // name of the persistent/session cookie
...
function Poll() { 
	...
	var alreadyShown2 = ForeCStdGetCookie(ckAlreadyShown2); // check if we already have shown 2nd survey
	var alreadyShown3 = ForeCStdGetCookie(ckAlreadyShown3); // check if we already have shown 3rd survey
	var pageCount;
	...
	if (stickyCounter != null) {
		...
		if(pageCount >= triggerParms["lf"]) {
			...
			if(alreadyShown == null && alreadyShown2 == null && alreadyShown3 == null) {
