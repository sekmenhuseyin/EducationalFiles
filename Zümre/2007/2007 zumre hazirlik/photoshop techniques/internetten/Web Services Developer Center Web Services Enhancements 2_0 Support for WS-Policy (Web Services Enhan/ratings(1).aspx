...
<!-- saved from url=(0213)http://msdn.microsoft.com/msdn-online/shared/components/ratings/ratings.aspx?ContentID=1042487&mnp2=1&Config=/msdn-online/shared/components/ratings/RatingsCnfg.xml&Print=wse2wspolicy.asp%26print=true&HideDiscuss=1 -->
...
<SCRIPT defer language=javascript>
		<!-- 
			var strPrintPage = ValidatePrintPage("wse2wspolicy.asp&print=true");
			var bMNP2 = true;
  ...
  <TR vAlign=top>
    ...
    <TD>
      ...
      style="MARGIN-LEFT: 10px; WIDTH: 190px">
        <TBODY>
        <TR>
          <TD colSpan=2>Average rating:<BR><STRONG>6</STRONG> out of 9</TD></TR>
        <TR>
          <TD colSpan=2>
            <TABLE border=0 cellPadding=0 cellSpacing=1>
              <TBODY>
              <TR vAlign=bottom>
                <TD><IMG align=bottom height=26 
                  src="ratings(1)_files/rtg_Bar.gif" width=12></TD>
                <TD><IMG align=bottom height=4 
                  src="ratings(1)_files/rtg_Bar.gif" width=12></TD>
                <TD><IMG align=bottom height=0 
                  src="ratings(1)_files/rtg_Bar.gif" width=12></TD>
                <TD><IMG align=bottom height=4 
                  src="ratings(1)_files/rtg_Bar.gif" width=12></TD>
                <TD><IMG align=bottom height=4 
        ...
        <TR>
          <TD><STRONG>22</STRONG> people have rated this 
